...
echo "create 1 route time (u sec): " . iterate(50000, $createRoute)/7 . "\n"; // 7 for 7 routes in for
...
echo "dispatch time (u sec): " . iterate(50000, $dispatchFunc)/5  . "\n"; // 5 for 5 dispatches in for
...
echo "20 routes & match last route, execution time (u sec): " . iterate(50000, $worstCaseSetup) . "\n";
